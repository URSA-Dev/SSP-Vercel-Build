...
let mockCases = [
  {
    ...
    caseType: 'PVP',
    caseSubtypes: ['Tier 3 Secret - Most common'],
    status: 'IN_REVIEW',
    priority: 'HIGH',
    assignedTo: 'Smith, A.',
    ...
    comms: [
      {
        ...
        body: 'PVP Tier 3 investigation received and assigned to adjudicator Smith, A.',
  ...
  },
  {
    ...
    caseType: 'PVP',
    caseSubtypes: ['Tier 5 Top Secret/SCI'],
    status: 'RECEIVED',
    priority: 'CRITICAL',
    assignedTo: 'Smith, A.',
    ...
    comms: [
      {
        ...
        body: 'PVP Top Secret case received. 48-hour suspense clock started.',
  ...
  },
  {
    ...
    caseType: 'SEAD3',
    caseSubtypes: ['Foreign Activities', 'Financial Anomalies'],
    status: 'QA_REVIEW',
    priority: 'NORMAL',
    assignedTo: 'Smith, A.',
    ...
    comms: [
      {
        ...
        direction: 'Outbound',
        subject: 'Case assignment notification',
        body: 'SEAD 3 Reporting case received and assigned.',
        suspenseEffect: 'Stops Suspense',
...
export async function createCase(data) {
  ...
  const caseId = `CID-${String(mockCases.length + 1).padStart(5, '0')}`;
  const newCase = {
    ...
    subjectId: data.subjectId || caseId,
    caseType: data.caseType || 'PVP',
    caseSubtypes: data.caseSubtypes || [],
